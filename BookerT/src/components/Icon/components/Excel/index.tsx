...
export const Excel: React.FC<Partial<IIcon & { style?: React.CSSProperties }>> = ({
  color,
  size,
  style,
  onClick
  ...
  return (
    ...
    >
      ...
      <g id="xxx-word">
        ...
        <path fill={color} d="M275,280H125a5,5,0,1,1,0-10H275a5,5,0,0,1,0,10Z" />

        <path fill={color} d="M200,330H125a5,5,0,1,1,0-10h75a5,5,0,0,1,0,10Z" />
